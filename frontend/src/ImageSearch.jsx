...
function ImageSearch({ collections, onImageSaved }) {
    ...
    // a new search always starts on page 1 and replaces any previous results
    ...
    // request the next Pixaby page and append it to the existing search results
    function loadMore() {
    ...
    // save the selected pixaby image through our Flask API then notify
    // App so collection previews can refresh immediately
